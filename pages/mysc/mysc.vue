		...
		<view class="sachv">
			...
			<image class="icon" src="../../static/index/sach.png" mode=""  @click="gosach"  ></image>
				...
				<view class="tab">
					...
					<view :class="istab==2?'ys1':'ys2'" @click="settab(2)">视频</view>
				</view>
...
<script>
	import {musicpalycx,usersp,musiclist,modules,muiscapi} from "../../api/index.js"
		...
		methods: {
		  async	gosach(){
			...
			async setdata(){
					...
					let arr2=(await muiscapi()).rows
					// console.log(arr2);
					let arr3=[]
					arr=(await musiclist()).rows;
			...
			async setdata2(){
					...
					this.data=(await modules()).rows;
					
					
							console.log("数据",await modules());
			}
		},
		 onLoad(query) {
		    // query 中包含 URL 参数
